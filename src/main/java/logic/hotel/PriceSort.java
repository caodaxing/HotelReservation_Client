...
public class PriceSort implements HotelSort{
	...
	public ArrayList<HotelVO> getSortedList(HotelSearchCondition condition, ArrayList<HotelVO> hotels) {
		if (hotels == null || condition != HotelSearchCondition.PRICE_UP
				|| condition != HotelSearchCondition.PRICE_DOWN) {
	 ...
	 * @author all
	 */
	public ArrayList<HotelVO> getSortedList(double startPrice, double endPrice, HotelSearchCondition condition,
			ArrayList<HotelVO> hotels) {
		if (hotels == null || startPrice >= endPrice || condition != HotelSearchCondition.PRICE_UP
				|| condition != HotelSearchCondition.PRICE_DOWN) {
			System.out.println("logic.hotel.PriceSort.getSortedList参数异常");
			return null;
		}
