...
public class OrderListDao_Stub implements OrderListDao{
	...
	public ArrayList<OrderPO> getOrderListByUserId(String userID) {
		...
		OrderPO po1 = new OrderPO("wyy", "20161231000060876", "00006", "2016-12-31 12:00:00",
				"2017-01-01 12:00:00", 1, RoomType.BIGBED_ROOM.ordinal(), false, 1, 1, 300, 240, "ppp", null, null, null, null);
		;
		OrderPO po2 = new OrderPO("wyy", "20161212000041212", "00004", "2016-12-12 12:00:00",
				"2016-12-13 12:00:00", 1, RoomType.STANDARD_ROOM.ordinal(), false, 1, 0, 400, 320, "ppp", null, null, null, null);
		
		OrderPO po3 = new OrderPO("wyy", "20160808000060634", "00006", "2016-08-08 12:00:00",
				"2016-08-09 12:00:00", 1, RoomType.SINGLE_ROOM.ordinal(), false, 1, 4, 300, 240, "ppp", null, null, null, null);
		
		OrderPO po4 = new OrderPO("wyy", "20150214000070886", "00007", "2015-02-14 12:00:00",
				"2015-02-15 12:00:00", 1, RoomType.SUITE.ordinal(), false, 1, 2, 500, 400, "ppp", null, null, null, null);
	...
	public ArrayList<OrderPO> getOrderListByHotelID(String hotelID) {
		...
		OrderPO po1 = new OrderPO("wyy", "20161231000060876", "00006", "2016-12-31 12:00:00",
				"2017-01-01 12:00:00", 1, RoomType.STANDARD_ROOM.ordinal(), false, 1, 1, 300, 240, "ppp", null, null, null, null);
		
		OrderPO po2 = new OrderPO("bcy", "20161212000061212", "00006", "2016-12-12 12:00:00",
				"2016-12-13 12:00:00", 1, RoomType.STANDARD_ROOM.ordinal(), false, 1, 0, 400, 320, "ppp", null, null, null, null);
		
		OrderPO po3 = new OrderPO("wyy", "20160808000060634", "00006", "2016-08-08 12:00:00",
				"2016-08-09 12:00:00", 1, RoomType.BIGBED_ROOM.ordinal(), false, 1, 4, 300, 240, "ppp",null, null, null, null);
		
		OrderPO po4 = new OrderPO("zdy", "20150214000060886", "00006", "2015-02-14 12:00:00",
				"2015-02-15 12:00:00", 1, RoomType.STANDARD_ROOM.ordinal(), false, 1, 2, 500, 400, "ppp", null, null, null, null);
	...
	public ArrayList<OrderPO> getAllDailyOrders(String time) {
		...
		OrderPO po2 = new OrderPO("bcy", "20161212000051212", "00005", "2016-12-12 12:00:00",
				"2016-12-13 12:00:00", 1, RoomType.SINGLE_ROOM.ordinal(), false, 1, 0, 400, 320, "ppp", null, null, null, null);
		
		OrderPO po3 = new OrderPO("wx", "20160808000060634", "00006", "2016-08-08 12:00:00",
				"2016-08-09 12:00:00", 1, RoomType.STANDARD_ROOM.ordinal(), false, 1, 4, 300, 240, "ppp", null, null, null, null);
