...
public class RoomDao_Stub implements RoomDao {
	...
	public RoomDao_Stub() {
		...
		this.pos1.add(new RoomPO("00001", "1009", RoomType.STANDARD_ROOM.ordinal(), 250, n12));
		
		this.pos1.add(new RoomPO("00001", "1203", RoomType.STANDARD_ROOM.ordinal(), 1200, null));
		
		
		HashMap<String, String> n21 = new HashMap<String, String>();
		n21.put("2017-01-01 12:00:00", "2017-01-02 12:00:00");
		this.pos2.add(new RoomPO("00002", "1109", RoomType.STANDARD_ROOM.ordinal(), 400, n21));
		
		HashMap<String, String> n22 = new HashMap<String, String>();
		n22.put("2017-01-03 12:00:00", "2017-01-04 12:00:00");
		this.pos2.add(new RoomPO("00002", "1009", RoomType.SINGLE_ROOM.ordinal(), 200, n22));
		
		this.pos2.add(new RoomPO("00002", "1203", RoomType.STANDARD_ROOM.ordinal(), 1200, null));

		
		HashMap<String, String> n31 = new HashMap<String, String>();
		n31.put("2017-01-07 12:00:00", "2017-01-08 12:00:00");
		this.pos3.add(new RoomPO("00003", "1109", RoomType.STANDARD_ROOM.ordinal(), 400, n31));
		...
		this.pos3.add(new RoomPO("00003", "1009", RoomType.SINGLE_ROOM.ordinal(), 400, n32));
		
		HashMap<String, String> n33 = new HashMap<String, String>();
		n33.put("2017-01-07 12:00:00", "2017-01-08 12:00:00");
		this.pos3.add(new RoomPO("00003", "1203", RoomType.STANDARD_ROOM.ordinal(), 1200, n33));
	}
