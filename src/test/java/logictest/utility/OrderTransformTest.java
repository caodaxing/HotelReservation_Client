...
public class OrderTransformTest {
	...
	public void testOrderListTransToVO() {
		...
		OrderPO po1 = new OrderPO("wyy", "20161212000041122", "green", "2016-09-09 12:00:00", 
				"2016-09-10 12:00:00", 1, 1, false, 2, 0, 400, 320, "ppp", 
				null, null, null, null);
		
		OrderPO po2 = new OrderPO("wyy", "20161214000041122", "green", "2016-12-13 12:00:00", 
				"2016-12-14 12:00:00", 1, 2, false, 2, 0, 300, 240, "ppp", 
				null, null, null, null);
	...
	public void testOrderTransToVO() {
		...
		OrderPO po = new OrderPO("wyy", "20161212000041122", "green", "2016-09-09 12:00:00", 
				"2016-09-10 12:00:00", 1, 3, false, 2, 0, 400, 320, "ppp", 
				null, null, null, null);
	...
	public void testOrderTransToPO() {
		...
		OrderVO vo = new OrderVO("wyy", "20161212000041122", RoomType.STANDARD_ROOM, 1, "2016-09-10 12:00:00", "2016-10-10 12:00:00",
				"green",  OrderState.UNEXECUTED, 2, false, 400, 320, promotion, null, null, null, null);
